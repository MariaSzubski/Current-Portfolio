...
<html>
	...
	<body>
		...
		<header>
			<div class="imagebg">
				<img src="../img/urbanwalls/banner.jpg" alt="Urban Walls: Community Revitalization Banner">
			</div>
			<div>
				<h1>Urban Walls: Community Revitalization</h1>
				<h2>A Cincinnati Public Art Narrative</h2>
			</div>
			<nav>
				<ul>
					<li>

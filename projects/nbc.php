...
<html>
	...
	<body>
		...
		<header>
			<div class="imagebg">
				<img src="../img/proj_nbc.jpg" alt="NBC Universal Careers Banner">
			</div>
			<div>
				<h1>NBCUniversal Careers</h1>
				<h2>A Redesigned Website Proposal</h2>
			</div>
			<nav>
				<ul>
					<li>
					...
					<li>
						<a href="urbanwalls.php"><span>Next Project</span>
							<svg xmlns="http://www.w3.org/2000/svg" width="18" height="28" viewBox="0 0 18 28">
